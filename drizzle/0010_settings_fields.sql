...
CREATE TABLE `__new_expenses_table` (
	...
	`dueDate` text DEFAULT '2026-06-18T13:40:57.423Z',
...
CREATE INDEX `idx_expenses_table_salary_id` ON `expenses_table` (`salaryId`);--> statement-breakpoint
ALTER TABLE `users_table` ADD `avatarUrl` text DEFAULT '';--> statement-breakpoint
ALTER TABLE `users_table` ADD `currency` text DEFAULT 'PHP';